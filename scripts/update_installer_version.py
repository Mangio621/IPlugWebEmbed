...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=IPlugWebEmbed Demo Installer\n"
      else:
        line="OutputBaseFilename=IPlugWebEmbed Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the IPlugWebEmbed Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the IPlugWebEmbed installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=IPlugWebEmbed Demo installer\n"
     else:
       line="SetupWindowTitle=IPlugWebEmbed installer\n"
